...
The command also generates `client/Cargo.lock`.

```sh
mix run -e 'Rekindle.ClientGenerator.write!("client", application_id: "my_app", package: "my_app_ui", web_binary: "my_app-web", desktop_binary: "my_app", targets: [:web, :desktop])'
```
